...
public final class Arrays {
    ...
    public static String bytesToString2(byte[] array) {
    ...
    /**
     * byte数组转成带0x前缀的十六进制字符串
     *
     * @param array     原数组
     * @param separator 分隔符
     * @return
     */
    public static String bytesToPrefixedHexString(byte[] array, String separator) {
        ...
        Formatter formatter = new Formatter(sb);
        formatter.format("0x%02X", array[0]);
        ...
        for (int i = 1; i < array.length; i++) {
            ...
            formatter.format("0x%02X", array[i]);
        }
